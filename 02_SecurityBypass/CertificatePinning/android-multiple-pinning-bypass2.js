/* 
    Description: Android Multiple Certificate Pinning ByPass
    Usage: frida -U -f XXX -l android-multiple-pinning-bypass2.js --no-pause
		...
		try 
		{
			...
			UnverifiedCertError.$init.implementation = function (str) 
			{
				...
				try 
				{
					...
					callingMethod.implementation = function() { rudimentaryFix(returnTypeName);};
				} 
				catch (e) 
				{
