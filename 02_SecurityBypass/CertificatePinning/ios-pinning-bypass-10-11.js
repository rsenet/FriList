/* 
    Description: iOS Certificate Pinning ByPass on iOS 10/11
    Usage: frida -U -f XXX -l ios-pinning-bypass-10-11.js
    Credit: ssl-kill-switch2
...
{ 
	...
	tls_helper_create_peer_trust = new NativeFunction(Module.findExportByName(null, "nw_tls_create_peer_trust"), 'int', ['pointer', 'bool', 'pointer']);
}
// iOS 10 
